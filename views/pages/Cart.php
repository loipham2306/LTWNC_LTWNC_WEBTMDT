                                    ...
                                    <tr>
                                        <td>
                                            <input
                                                ...
                                                type="checkbox"
                                                value="<?= $key ?>"
                                                data-unit-price="<?= $item['gia_thuc'] ?>" 
                                                data-price="<?= $item['gia_thuc'] * $item['so_luong'] ?>"
...
<td>
    <?php if ($item['phan_tram'] > 0): ?>
        <div class="text-white-50" style="font-size: 0.85em;">
            <del><?= number_format($item['gia_goc'], 0, ',', '.') ?> đ</del>
        </div>
        <div class="price-highlight">
            <?= number_format($item['gia_thuc'], 0, ',', '.') ?> đ
        </div>
    <?php else: ?>
        <div class="fw-bold">
                    ...
                    <div class="text-end">
                        ...
                        <span class="fs-3 fw-bold text-orange" id="total-price" style="color: #F28B00;">
                            ...
                            foreach ($_SESSION['cart'] as $item) {
                                $tong += ($item['gia_thuc'] * $item['so_luong']);
                            }
