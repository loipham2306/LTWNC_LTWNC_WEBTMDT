<style>
    ...
    /* 1. KHỐI NỀN CAM BỊ CẮT XÉO (Tạo viền ngoài) */
    .esport-bg {
        ...
        /* Cắt khối nền màu cam theo hình zíc zắc sấm sét */
        clip-path: polygon(0 0, 100% 0, 82% 48%, 95% 48%, 78% 100%, 0 100%);
    }

    /* 2. ẢNH SẢN PHẨM BỊ CẮT XÉO (Nhỏ hơn nền cam để lộ viền) */
    .hero-img-full {
        width: 100%;
        height: 480px;
        object-fit: cover;
        object-position: top center;
        /* Cắt ảnh lùi vào 2% so với nền cam để lộ ra viền "sấm sét" */
                        ...
                        <div class="banner-main">
                            <div class="row g-0 w-100 align-items-center"> 
                                ...
                                <div class="col-md-6 text-white ps-4 pe-4 wow fadeInRight" data-wow-delay="0.3s">
                                    ...
                                    <button class="btn btn-orange rounded-0 px-5 py-3 fs-5">KHÁM PHÁ NGAY</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="banner-main">
                            <div class="row g-0 w-100 align-items-center"> 
                                ...
                                <div class="col-md-6 text-white ps-4 pe-4">
                                    ...
                                    <button class="btn btn-orange rounded-0 px-5 py-3 fs-5">MUA SẮM NGAY</button>
                                </div>
                            </div>
                        </div>
                    </div>
