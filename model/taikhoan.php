<?php
    class TaiKhoan{
        ...
        public function getIdTaiKhoan(){
            return $this->id_tai_khoan;
        }

        public function setIdTaiKhoan($id_tai_khoan){
        ...
        public function __construct($db, $id_tai_khoan = null, $ten_dang_nhap = null, $email = null, $mat_khau = null, 
        $vai_tro = null, $trang_thai = null, $ngay_tao = null) {
            $this->conn = $db;
            $this->id_tai_khoan = $id_tai_khoan;
            $this->ten_dang_nhap = $ten_dang_nhap;
            $this->email = $email;
        ...
        public function updateTrangThaiTaiKhoan($id_tai_khoan, $trang_thai) {
            // Sửa lại tên bảng khớp với DB (thường là 'tai_khoan')
